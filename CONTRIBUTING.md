...
- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/smtp-integrator-operator/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/smtp-integrator-operator)
...
Canonical welcomes contributions to the SMTP Integrator Operator. Please check out our
...
OCI image for the SMTP Integrator app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./smtp-integrator*.charm 
```
